...
export class GraduationService {
  ...
  public static getConditions(major: string, isTransfer: boolean) {
    ...
    return { pblTotal, pblMajor, englishCourses, socialService, industry };
  }
  ...
  public static calculateRequirements({
    ...
    return {
      totalCredits: this.getTotalCredits(major),
      major: this.getMajorCredits(major, admissionYear, isTransfer, hasSecondMajor),
      generalElective: this.getGeneralElectiveCredits(major),
      conditions: this.getConditions(major, isTransfer)
    };
  }
}
