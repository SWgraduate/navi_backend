  ...
  return (
    <div style={{ display: "flex", width: "100%", height: "100%" }}>
      ...
      >
        ...
        <button onClick={() => onScreenChange("chat")} style={navButtonStyle("chat")}>
          Chat
        </button>

        <button onClick={() => onScreenChange("upload")} style={navButtonStyle("upload")}>
          Upload
        </button>

        <div style={{ marginTop: "16px", marginBottom: "8px", color: "#8e8ea0", fontSize: "0.9rem" }}>
          Chat History
        </div>
